...
function Header() {
  ...
  return (
    <>
      ...
      {/*  Audio Set */} 
      <audio id="myAudio">
        <source src="/sound/learnAudio" type="audio/ogg"/>
        <source src="/sound/learnAudio.mp3" type="audio/mpeg" />
